...
module BootstrapForm
  class FormBuilder < ActionView::Helpers::FormBuilder
    ...
    # Rails > 4 supported field removed..
    #color_field date_field datetime_field datetime_local_field month_field time_field week_field
    FIELD_HELPERS = %w{email_field number_field password_field phone_field range_field search_field telephone_field text_area text_field url_field}
